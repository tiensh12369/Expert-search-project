...
class run_factor_integration:
    def __init__(self, keyid, fid):
        ...
        # with open('/home/search/apps/product/combine/ko_stopword.txt', 'r', encoding='utf-8') as f:
    ...
    def factor_norm(self):
        ...
        # print("real_recentness : ",real_recentness,"real_coop: ",real_coop,"norm_remainQual_factor : ",norm_remainQual_factor, "norm_ntisQual_factor",norm_ntisQual_factor)
            ...
            {"keyId":self.keyid, "fid":self.fid}, [
                {"$set" : {
                    ...
                    "score" : {
                        ...
                        {"$multiply": ["$factor.coop", real_coop, 10]},
                        {"$multiply": [
                            {"$sum":[
                                {"$multiply": [real_recentness, "$factor.qunt", 0.66]},
                                "$factor.lct"]}, 30]}
