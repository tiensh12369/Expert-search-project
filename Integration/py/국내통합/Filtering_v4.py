...
for i in range(len(key_querys)):
    ...
    for key_query in key_querys[i]: #rawdata(magid, paper) insert
        ...
        if f_id < 1 and fid_key_query == None:
            ...
            ntis_inst = key_query['originalName']
            ...
            paper_inst = key_query['originalName'].split(';')[0]
